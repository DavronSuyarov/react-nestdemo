      ...
      <div className="col-lg-1-5 primary-sidebar sticky-sidebar">
        <div className="sidebar-widget widget-store-info mb-30 bg-3 border-0">
          ...
          <div className="vendor-info">
            ...
            <h4 className="mb-5"><a href="vendor-details-1.html" className="text-heading">Nest Food.,Ltd</a></h4>
            ...
            <div className="vendor-des mb-30">
              <p className="font-sm text-heading">Got a smooth, buttery spread in your fridge? Chances are good that it's Good Chef. This brand made Lionto's list of the most popular grocery brands across the country.</p>
            </div>
            ...
            <div className="vendor-info">
              ...
              <a href="vendor-details-1.html" className="btn btn-xs">Contact Seller <i className="fi-rs-arrow-small-right" /></a>
            </div>
          </div>
        </div>
