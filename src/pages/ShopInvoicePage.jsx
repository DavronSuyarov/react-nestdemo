    ...
    <div className='invoice invoice-content invoice-1'>
      <div className='back-top-home hover-up mt-30 ml-30'>
        <a className='hover-up' href='index.html'>
          <i className='fi-rs-home mr-5' /> Homepage
        </a>
      </div>
                    ...
                    <div className='col-sm-6'>
                      <div className='invoice-name'>
                        <div className='logo'>
                          <a href='index.html'>
                            <img
                              src='assets/imgs/theme/logo-light.svg'
                              alt='logo'
                            />
                          </a>
                        </div>
                      ...
                      <div className='invoice-number'>
                        ...
                        <p className='invoice-addr-1'>
                          ...
                          <a
                            ...
                            data-cfemail='bfddd6d3d3d6d1d8fff1dacccbf2decdcb91dcd0d2'
                          >
                            [email&nbsp;protected]
                          </a>{' '}
                          <br />
...
export default ShopInvoicePage;
