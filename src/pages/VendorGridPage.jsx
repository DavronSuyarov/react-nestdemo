...
const VendorGridPage = () => {
  return <main className="main pages mb-80">
        ...
        <div className="col-lg-3 col-md-6 col-12 col-sm-6">
          <div className="vendor-wrap mb-40">
            ...
            <div className="vendor-content-wrap">
              ...
              <a href="vendor-details-1.html" className="btn btn-xs">Visit Store <i className="fi-rs-arrow-small-right" /></a>
            </div>
          </div>
        </div>
        {/*end vendor card*/}
        ...
        <div className="col-lg-3 col-md-6 col-12 col-sm-6">
          <div className="vendor-wrap mb-40">
            <div className="vendor-img-action-wrap">
              <div className="vendor-img">
                <a href="vendor-details-1.html">
                  <img className="default-img" src="assets/imgs/vendor/vendor-5.png" alt="" />
                </a>
              </div>
            </div>
            <div className="vendor-content-wrap">
        ...
        <div className="col-lg-3 col-md-6 col-12 col-sm-6">
          <div className="vendor-wrap mb-40">
            <div className="vendor-img-action-wrap">
              <div className="vendor-img">
                <a href="vendor-details-1.html">
                  <img className="default-img" src="assets/imgs/vendor/vendor-11.png" alt="" />
                </a>
              </div>
            </div>
            <div className="vendor-content-wrap">
        ...
        <div className="col-lg-3 col-md-6 col-12 col-sm-6">
          <div className="vendor-wrap mb-40">
            <div className="vendor-img-action-wrap">
              <div className="vendor-img">
                <a href="vendor-details-1.html">
                  <img className="default-img" src="assets/imgs/vendor/vendor-6.png" alt="" />
                </a>
              </div>
            </div>
            <div className="vendor-content-wrap">
        ...
        <div className="col-lg-3 col-md-6 col-12 col-sm-6">
          <div className="vendor-wrap mb-40">
            <div className="vendor-img-action-wrap">
              <div className="vendor-img">
                <a href="vendor-details-1.html">
                  <img className="default-img" src="assets/imgs/vendor/vendor-12.png" alt="" />
                </a>
              </div>
            </div>
            <div className="vendor-content-wrap">
        ...
        <div className="col-lg-3 col-md-6 col-12 col-sm-6">
          <div className="vendor-wrap mb-40">
            <div className="vendor-img-action-wrap">
              <div className="vendor-img">
                <a href="vendor-details-1.html">
                  <img className="default-img" src="assets/imgs/vendor/vendor-13.png" alt="" />
                </a>
              </div>
            </div>
            <div className="vendor-content-wrap">
        ...
        <div className="col-lg-3 col-md-6 col-12 col-sm-6">
          <div className="vendor-wrap mb-40">
            <div className="vendor-img-action-wrap">
              <div className="vendor-img">
                <a href="vendor-details-1.html">
                  <img className="default-img" src="assets/imgs/vendor/vendor-14.png" alt="" />
                </a>
              </div>
            </div>
            <div className="vendor-content-wrap">
        ...
        <div className="col-lg-3 col-md-6 col-12 col-sm-6">
          <div className="vendor-wrap mb-40">
            <div className="vendor-img-action-wrap">
              <div className="vendor-img">
                <a href="vendor-details-1.html">
                  <img className="default-img" src="assets/imgs/vendor/vendor-15.png" alt="" />
                </a>
              </div>
            </div>
            <div className="vendor-content-wrap">
