          ...
          <div className="vendor-wrap style-2 mb-40">
            ...
            <div className="vendor-content-wrap">
              <div className="mb-30">
                ...
                <h4 className="mb-5"><a href="vendor-details-1.html">Red Baron</a></h4>
                <div className="product-rate-cover">
                  <div className="product-rate d-inline-block">
                    <div className="product-rating" style={{width: '90%'}} />
                  </div>
          ...
          <div className="vendor-wrap style-2 mb-40">
            ...
            <div className="vendor-content-wrap">
              <div className="mb-30">
                ...
                <h4 className="mb-5"><a href="vendor-details-1.html">Noodle Soup</a></h4>
                <div className="product-rate-cover">
                  <div className="product-rate d-inline-block">
                    <div className="product-rating" style={{width: '90%'}} />
                  </div>
          ...
          <div className="vendor-wrap style-2 mb-40">
            ...
            <div className="vendor-content-wrap">
              <div className="mb-30">
                ...
                <h4 className="mb-5"><a href="vendor-details-1.html">Maruchan Ram</a></h4>
                <div className="product-rate-cover">
                  <div className="product-rate d-inline-block">
                    <div className="product-rating" style={{width: '90%'}} />
                  </div>
